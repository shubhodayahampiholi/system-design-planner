        ...
        "messages": [
            {
                "role": "user",
                "content": (
                    "Delegate to your governance-specialist: what's the "
                    "recommended approach for governing AI agent access to "
                    "Unity Catalog data, given our current scoping constraints?"
                ),
            }
        ]
    },
